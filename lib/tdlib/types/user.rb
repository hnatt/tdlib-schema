module TD::Types
  ...
  # @attr has_anonymous_phone_number [Boolean] True, if the user's phone number was bought on Fragment and isn't tied
  #   to a SIM card.
  ...
  class User < Base
    ...
    attribute :has_anonymous_phone_number, TD::Types::Bool

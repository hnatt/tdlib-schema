module TD::Types
  ...
  #   primary username.
  #   The order of active usernames can be changed with reorderActiveUsernames or reorderSupergroupActiveUsernames.
  # @attr disabled_usernames [Array<TD::Types::String>] List of currently disabled usernames; the username can be
  #   activated with toggleUsernameIsActive/toggleSupergroupUsernameIsActive.
  # @attr editable_username [TD::Types::String] The active username, which can be changed with
